...
void main(void) {
    ...
    _delay((unsigned long)((10000)*(20000000L/4000.0)));
    ...
    while(1){
        ...
        BMP280_readTemperature(&temp);
        BMP280_readPressure(&pres);
        ...
        for(i=0;i<5;i++){
            ...
            if(boton == 1){
                ...
                LCD_Goto(1, 2);
                LCD_Print(lcd_text);
                _delay((unsigned long)((4000)*(20000000L/4000.0)));
            }
        }
        ...
        UART_Print("\r\n\r\n");
        _delay((unsigned long)((5000)*(20000000L/4000.0)));
    }
}
