...
void start_signal_dht11(void) {
  ...
  _delay((unsigned long)((25)*(20000000L/4000.0)));
  PORTAbits.RA0 = 1;

  _delay((unsigned long)((30)*(20000000L/4000000.0)));
  TRISAbits.TRISA0 = 1;
}
...
__bit check_response_dht11(void) {
    ...
    while(!PORTAbits.RA0 && ((TMR1L | ((uint16_t)TMR1H << 8)) < 500));
    if((TMR1L | ((uint16_t)TMR1H << 8)) > 500){
        return 0;
    }
...
__bit read_data_dht11(unsigned char* dht_data)
{
    *dht_data = 0;
    ...
    for(char i = 0; i < 8; i++)
    {
        ...
        else if((TMR1L | ((uint16_t)TMR1H << 8)) > 200)
            *dht_data |= (1 << (7 - i));
