...
void Expander_Write(uint8_t value)
{
  ...
  I2C_start();
  I2C_Tx_data(i2c_addr);
  I2C_Tx_data(value | backlight_val);
  I2C_stop();
}
...
void LCD_Write_Nibble(uint8_t n)
{
  ...
  _delay((unsigned long)((1)*(20000000L/4000000.0)));
...
void LCD_Begin(uint8_t address)
{
  i2c_addr = address;
  Expander_Write(0);

  _delay((unsigned long)((40)*(20000000L/4000.0)));
  LCD_Cmd(3);
  _delay((unsigned long)((5)*(20000000L/4000.0)));
  LCD_Cmd(3);
  _delay((unsigned long)((5)*(20000000L/4000.0)));
  LCD_Cmd(3);
  _delay((unsigned long)((5)*(20000000L/4000.0)));
  ...
  _delay((unsigned long)((5)*(20000000L/4000.0)));
  LCD_Cmd(0x20 | (2 << 2));
  _delay((unsigned long)((50)*(20000000L/4000.0)));
  LCD_Cmd(0x0C);
  _delay((unsigned long)((50)*(20000000L/4000.0)));
  LCD_Cmd(0x01);
  _delay((unsigned long)((50)*(20000000L/4000.0)));
