...
_Bool BMP280_begin(uint8_t mode,uint8_t T_sampling,uint8_t P_sampling,uint8_t filter,uint8_t standby);
_Bool BMP280_ForcedMeasurement();
void BMP280_Update();
...
_Bool BMP280_begin(uint8_t mode,
                  uint8_t T_sampling ,
                  uint8_t P_sampling ,
                  uint8_t filter ,
                  uint8_t standby )
{
    ...
    BMP280_calib.dig_T2 = (int16_t)BMP280_Read16(0x8A);
    BMP280_calib.dig_T3 = (int16_t)BMP280_Read16(0x8C);

    BMP280_calib.dig_P1 = BMP280_Read16(0x8E);
    BMP280_calib.dig_P2 = (int16_t)BMP280_Read16(0x90);
    BMP280_calib.dig_P3 = (int16_t)BMP280_Read16(0x92);
    BMP280_calib.dig_P4 = (int16_t)BMP280_Read16(0x94);
    BMP280_calib.dig_P5 = (int16_t)BMP280_Read16(0x96);
    BMP280_calib.dig_P6 = (int16_t)BMP280_Read16(0x98);
    BMP280_calib.dig_P7 = (int16_t)BMP280_Read16(0x9A);
    BMP280_calib.dig_P8 = (int16_t)BMP280_Read16(0x9C);
    BMP280_calib.dig_P9 = (int16_t)BMP280_Read16(0x9E);
    ...
    BMP280_Write(0xF5, _config);
    BMP280_Write(0xF4, _ctrl_meas);
